...
{
    static class EmployeesDataSource 
    {
        static public IList<EmployeeAuthritySync> GetEmployeesAuthoritySyncList(IEnumerable<Employees> employeesObject)
        {
            DataTable dt = KCSDatabaseHelper.Instance.GetEmployeesAuthoritySync(employeesObject);
            return KCS.Common.Utils.ModelConvertHelper<EmployeeAuthritySync>.ConvertToModel(dt);
        }
        static public IList<EmployeeJobCode> GetJobCodeList()
        {
            DataTable dt = KCSDatabaseHelper.Instance.GetJobCodeList();
            return KCS.Common.Utils.ModelConvertHelper<EmployeeJobCode>.ConvertToModel(dt);
        }
