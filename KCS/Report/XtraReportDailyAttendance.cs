...
{
    public partial class XtraReportDailyAttendance : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportDailyAttendance(string checkDate, object source)
        {
            InitializeComponent();
           ...
           // xrLabelDepartment.Text = LanguageResource.GetDisplayString("DepartmentName") + ":";
            xrLblEmpID.Text = LanguageResource.GetDisplayString("EmployeeID") + ":";
            xrLblEmpName.Text = LanguageResource.GetDisplayString("EmployeeName") + ":";

           
           // xrLblEmpName.Text = LanguageResource.GetDisplayString("AccessControlHoliType");
            ...
            xrLabelHeader1.Text = checkDate + " " + LanguageResource.GetDisplayString("ReportDetails");
